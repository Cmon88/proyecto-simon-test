...
| Grafana | http://localhost:3000 | \dmin\ / \dmin\ (or anonymous read-only mode) |
...
- **Token-by-Token Streaming:** Handled natively via WebSockets (events \ssistant:delta\, \ssistant:done\).
